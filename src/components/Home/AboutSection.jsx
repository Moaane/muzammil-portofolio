...
export default function AboutSection() {
  return (
    <div className="w-screen max-w-[1440px] flex flex-col lg:flex-row gap-6 px-4 md:px-8 lg:px-24 space-x-2">
      <div className="flex flex-col lg:w-1/2 md:gap-4 lg:justify-between">
