...
export default function HeroSection() {
  return (
    <div className="w-screen flex flex-col items-center justify-between lg:flex-row lg:py-8 lg:space-y-0 max-w-[1440px] px-4 md:px-8 lg:px-24 space-y-6 md:space-y-12 hero">
