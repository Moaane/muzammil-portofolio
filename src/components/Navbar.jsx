...
export default function Navbar() {
  return (
    <div className="fixed w-screen h-[7vh] top-0 md:h-[8vh] lg:h-[10vh] z-10 flex justify-center bg-white">
      {/* Mobile Navbar */}
      ...
      {/* Desktop Navbar */}
      <div className="navbar-center h-full lg:w-full hidden lg:flex lg:max-w-[1440px]  md:px-24 2xl:px-0 items-center gap-3">
